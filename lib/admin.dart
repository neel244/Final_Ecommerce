import 'package:auth/add_products.dart';
import 'package:auth/brandlist_adminside.dart';
import 'package:auth/categorylist.dart';
import 'package:auth/db/brand.dart';
import 'package:auth/productlist_admin.dart';
...
import 'brandlist_adminside.dart';
import 'productlist_admin.dart';
...
class _AdminState extends State<Admin> {
  ...
  void getinfo() async {
    var productinfo =
        await Firestore.instance.collection('productsell').getDocuments();
    print(productinfo);
    setState(() {
